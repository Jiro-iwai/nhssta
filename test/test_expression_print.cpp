...
TEST_F(ExpressionPrintTest, PrintAllWithConst) {
    ...
    std::string output = captureOutput([]() { print_all(); });

    // Expected format: id (5 chars), value (10 chars), op (10 chars), left (10 chars), right (10
    // chars), left_id (10 chars), right_id (10 chars)
