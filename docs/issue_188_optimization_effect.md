...
| 項目 | 最適化前 | 最適化後 | 削減 | 削減率 |
|------|---------|---------|------|--------|
| Expression node count after building objective | 4,063 | 3,963 | **100** | **2.5%** |

### Endpoint 0 (G17) の内訳

| 項目 | 最適化前 | 最適化後 | 削減 | 削減率 |
|------|---------|---------|------|--------|
| mean_expr | 2,745 | 2,745 | 0 | 0% |
| std_expr | 1,310 | 1,210 | **100** | **7.6%** |
| **合計** | **4,058** | **3,958** | **100** | **2.5%** |
